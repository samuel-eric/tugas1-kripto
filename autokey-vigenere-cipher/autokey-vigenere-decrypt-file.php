...
<div class="card position-absolute top-50 start-50 translate-middle">
  <div class="card-body">
    ...
    <h5 class="card-title fs-3 text-center">Decrypt Vigenere Cipher with Text File</h5>
    <hr>
    <form method="post" enctype="multipart/form-data">
      ...
      <button type="submit" name="submit" class="btn btn-primary w-full p-2">Decrypt</button>
    </form>
    <hr>
